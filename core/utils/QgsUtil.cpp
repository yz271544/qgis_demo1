...
void QgsUtil::show_layer_label(QgsVectorLayer* layer, const std::string& style) {
    ...
    QgsTextFormat text_format = QtFontUtil::create_font(style, 12.0, "#000000", false, false, Qgis::TextOrientation::Horizontal, 0.0);
...
QgsVectorLayerSimpleLabeling* QgsUtil::get_layer_label(const std::string& style, const std::string& label_of_field_name) {
    QgsPalLayerSettings label_settings;
...
QgsVectorLayer* QgsUtil::write_persisted_layer(const QString& layer_name, QgsVectorLayer* layer,
