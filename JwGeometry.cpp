...
QgsPoint* JwGeometry::transform_point(const std::vector<double>& point, const QgsCoordinateTransform& transformer) {
...
QgsGeometry JwGeometry::transform_polygon(const std::vector<std::vector<QgsPoint>>& transformed_polygon) {
...
QgsGeometry JwGeometry::paint_circle_geometry_3d(int num_segments, const QgsPoint& center_transformed, double radius) {
...
QgsGeometry JwGeometry::paint_circle_geometry_2d(int num_segments, const QgsPoint& center_transformed, double radius) {
