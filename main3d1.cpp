...
int main(int argc, char *argv[]) {
    ...
    QJsonObject font_style = QJsonDocument::fromJson(font_style_payloads.toUtf8()).object();

    QString layer_style_payloads = R"({\"scale\":0.8})";
    QJsonObject layer_style = QJsonDocument::fromJson(layer_style_payloads.toUtf8()).object();

    QgsFeatureRenderer* feature_renderer = StylePoint::get2d_rule_based_renderer(font_style, layer_style, icon_path, 6.0);
